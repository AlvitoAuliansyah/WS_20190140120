 ...
 */
package com.pwsa.tugas0;

import com.pwsa.tugas0.exceptions.NonexistentEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.pwsa.tugas_20190140120_jar_0.0.1-SNAPSHOTPU");

    public EntityManager getEntityManager() {
        return emf.createEntityManager();
    }

    public void create(Datamahasiswa datamahasiswa) {
